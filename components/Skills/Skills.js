...
const Skills = () => {
  const iconClassName =
    "text-6xl md:text-9xl text-primary-light dark:text-primary-dark";
        ...
        >
          ...
          <Parallax baseVelocity={-3}>
            <div className="flex space-x-10 md:space-x-20 ml-10 md:ml-20">
              <SkillItem
                text="Redux"
                icon={<SiRedux className={iconClassName} />}
              />
              <SkillItem
                text="React Router"
                icon={<SiReactrouter className={iconClassName} />}
              />
              <SkillItem
                text="Mongo DB"
              ...
              <SkillItem
                text="Sql"
                icon={<HiDatabase className={iconClassName} />}
              />
            </div>
          </Parallax>
          <Parallax baseVelocity={4}>
            <div className="flex space-x-10 md:space-x-20 ml-10 md:ml-20">
              <SkillItem
                text="Kotlin"
                icon={<SiKotlin className={iconClassName} />}
              />
              <SkillItem
                text="Python"
                icon={<SiPython className={iconClassName} />}
              />
              <SkillItem
                text="Java"
                icon={<SiJava className={iconClassName} />}
              />
              <SkillItem
                text="Sql Lite"
          ...
          <Parallax baseVelocity={-5}>
            <div className="flex space-x-10 md:space-x-20 ml-10 md:ml-20">
              ...
              <SkillItem
                text="C++"
                icon={<SiCplusplus className={iconClassName} />}
              />
            </div>
          </Parallax>
